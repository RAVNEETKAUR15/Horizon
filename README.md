...
This project predicts how much electric a region will use **tomorrow, hour by hour,** and measures itself against the one benchmark that actually matters: the grid operators' own published forecasts. In California, it beats them.
